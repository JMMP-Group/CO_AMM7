...
!AW - add cumulative barotropic velocities
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:) ::   u_b_cum  !: accumulation of Barotropic velocities at u-point [m/s]
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:) ::   v_b_cum  !: accumulation of Barotropic velocities at v-point [m/s]
...
!AW
         &      u_b_cum(jpi,jpj)  , v_b_cum(jpi,jpj)   ,                    &
!AW end
