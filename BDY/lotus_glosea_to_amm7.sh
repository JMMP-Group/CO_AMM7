...
for month in 01 02 03 04 05 06 07 08 09 10 11 12; do
	...
	export TARGET_DIR=SYMLINK_DIR/${year}/${month}/
	...
	namelist_template="namelist_local_glosea6_template.bdy"
	namelist="namelist_local_glosea6_"${year}${month}".bdy"

	# ncml file is referenced in the namelist
	ncml_template="src_data_local_glosea6_TEMPLATE_regexp.ncml"
	ncml="src_data_local_glosea6_"${year}${month}"_regexp.ncml"
